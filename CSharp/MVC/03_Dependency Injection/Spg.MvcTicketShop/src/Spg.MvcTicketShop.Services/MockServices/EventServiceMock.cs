...
namespace Spg.MvcTicketShop.Services.MockServices
{
    public class EventServiceMock : IEventService
    {
        ...
        public Task<IEnumerable<Events>> GetAllAsync(string filter, string currentFilter, Guid? state, string sortOrder, int? pageNumber)
        {
