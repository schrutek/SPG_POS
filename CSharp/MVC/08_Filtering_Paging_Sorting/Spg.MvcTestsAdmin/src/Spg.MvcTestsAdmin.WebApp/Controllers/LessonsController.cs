...
namespace Spg.MvcTestsAdmin.WebApp.Controllers
{
    ...
    public class LessonsController : Controller
    {
        ...
        [HttpGet("byid/{schoolclassId}")]
        public async Task<IActionResult> IndexByLessonId(string schoolclassId, int pageIndex, string filter, string currentFilter)
        {
            ...
            pageIndex = pageIndex == 0 ? 1 : pageIndex;
            var testsAdministratorContext = await _lessonService.GetAllBySchoolclassAsync(schoolclassId, pageIndex, filter);
