...
namespace Spg.MvcTestsAdmin.WebApp.Controllers
{
    public class LessonsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("L_ID,L_Untis_ID,L_Class,L_Teacher,L_Subject,L_Room,L_Day,L_Hour")] Lesson lesson)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("L_ID,L_Untis_ID,L_Class,L_Teacher,L_Subject,L_Room,L_Day,L_Hour")] Lesson lesson)
        {
            if (id != lesson.L_ID)
            {
                return NotFound();
