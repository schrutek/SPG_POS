...
namespace Spg.AsyncAwait.Tests
{
    internal class Program
    {
        ...
        private static async Task MainAsync()
        {
            ...
            // DON'T:
            // Hier wird im selben Thread fortgesetzt. Die Funktion blockiert also bis zum Ende
            // beider Methoden. Das macht nur Sinn, wenn in einer synchronen Methode synchronisiert
