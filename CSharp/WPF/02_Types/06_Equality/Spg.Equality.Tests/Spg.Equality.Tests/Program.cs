...
namespace Spg.Equality.Tests
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine($"== :      {engines[1] == engines[5]}");
            Console.WriteLine($"Equals:   {engines[1].Equals(engines[5])}");
            Console.WriteLine($"Contains: {engines.Contains(new Engine("Chrycler", 5023, 721))}");
