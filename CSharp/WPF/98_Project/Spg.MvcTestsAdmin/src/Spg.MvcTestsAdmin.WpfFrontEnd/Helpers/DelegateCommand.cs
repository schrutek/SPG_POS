...
namespace Spg.MvcTestsAdmin.WpfFrontEnd.Helpers
{
    public class DelegateCommand : ICommand
    {
        ...
        /// <param name="execute">Funktion, die ausgeführt wird, wenn der Button gedrückt wird.</param>
        /// <param name="canExecute">Funktion, die bestimmt, ob der Button aktiv ist.</param>
        public DelegateCommand(Action execute, Func<bool> canExecute) : this((param) => execute(), (param) => canExecute())
        { }

        public DelegateCommand(Action<object> execute) : this(execute, (param) => true)
        { }

        public DelegateCommand(Action execute) : this((param) => execute(), (param) => true)
        { }
